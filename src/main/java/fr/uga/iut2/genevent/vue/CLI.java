...
//-----  Implémentation des méthodes abstraites  -------------------------------
    ...
    @Override
    public final void demarrerInteraction() throws UtilisateurException {
        Commande cmd;
        do {
    ...
    @Override
    public void saisirNouvelEvenement(final Set<String> nomsExistants) throws UtilisateurException {
